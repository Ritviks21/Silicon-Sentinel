...
if model is not None:
    ...
    # Define paths to your sample images in the GitHub repo
    # IMPORTANT: Replace 'main' with your branch name if different
    ...
    } # Make sure your uploaded sample filenames match these!
